...
var FRAME = {
    ...
    width : 100,
    height: 77,
    sprite: { top: 300, left: 270, width: 100, height: 77 }
};
...
var BUTTONS = {
    ...
    start: {
        ...
        label : 'Новая игра',
        sprite: {
            normal: { left: 270, top: 0, width: 100, height: 30 },
            hover : { left: 270, top: 30, width: 100, height: 30 }
        }
    ...
    pause: {
        ...
        label : 'Пауза (P)',
        sprite: {
            normal: { left: 270, top: 120, width: 100, height: 30 },
            hover : { left: 270, top: 150, width: 100, height: 30 }
        }
    },
    save : {
        left  : 885,
        ...
        label : 'Сохранить',
        sprite: {
            normal: { left: 270, top: 180, width: 100, height: 30 },
            hover : { left: 270, top: 210, width: 100, height: 30 }
        }
    },
    load : {
        left  : 885,
        ...
        label : 'Загрузить',
        sprite: {
            normal: { left: 270, top: 240, width: 100, height: 30 },
            hover : { left: 270, top: 270, width: 100, height: 30 }
        }
    }
};

var SCORE = {
    base: (BALL.maxSpeed - BALL.minSpeed) / 2 + (PAD.maxSize - PAD.minSize) / 2 + 5,
    clearRect: {
        left  : 0,
        top   : 200,
        width : 150,
